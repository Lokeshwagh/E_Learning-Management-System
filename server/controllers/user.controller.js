...
export const loginUser = asyncHandler(async (req, res, next) => {
  ...
  // Setting the token in the cookie with name token along with cookieOptions
  res.cookie('token', token, cookieOptions);// clinet pashipasseord nahi gela pahijen
...
export const changePassword = asyncHandler(async (req, res, next) => {
  ...
  // Setting the password undefined so that it won't get sent in the response password leak nahi zala pahijen manun thy password le undefiend set kela 
  user.password = undefined;
